...
class PersonBehandlerApiTest {
    ...
    inner class GetListOfBehandlerForPersonident {
        private val dtoClassName = PersonBehandlerDTO::class.java.simpleName
        ...
        inner class HappyPath {
            @Test
            fun `should return list of $dtoClassName and store behandler if request is successful`() {
            ...
            @Test
            fun `should return empty list of $dtoClassName for person missing Fastlege`() {
                val validToken = generateJWTIdporten(
                    audience = externalMockEnvironment.environment.idportenTokenXClientId,
                    clientId = externalMockEnvironment.environment.aapSoknadApiClientId,
                    issuer = externalMockEnvironment.wellKnownInternalIdportenTokenX.issuer,
            ...
            @Test
            fun `should return empty list of $dtoClassName for person with Fastlege missing foreldreEnhetHerId`() {
                val validToken = generateJWTIdporten(
                    audience = externalMockEnvironment.environment.idportenTokenXClientId,
                    clientId = externalMockEnvironment.environment.aapSoknadApiClientId,
                    issuer = externalMockEnvironment.wellKnownInternalIdportenTokenX.issuer,
            ...
            @Test
            fun `should return empty list of $dtoClassName for person with Fastlege missing partnerinfo`() {
                val validToken = generateJWTIdporten(
                    audience = externalMockEnvironment.environment.idportenTokenXClientId,
                    clientId = externalMockEnvironment.environment.aapSoknadApiClientId,
                    issuer = externalMockEnvironment.wellKnownInternalIdportenTokenX.issuer,
            ...
            @Test
            fun `should return empty list of $dtoClassName for person with fastlege missing fnr, hprId and herId`() {
                val validToken = generateJWTIdporten(
                    audience = externalMockEnvironment.environment.idportenTokenXClientId,
                    clientId = externalMockEnvironment.environment.aapSoknadApiClientId,
                    issuer = externalMockEnvironment.wellKnownInternalIdportenTokenX.issuer,
