    ...
    inner class HappyPath {
        ...
        fun `should return list of PersonBehandlerDTO and store behandler if request is successful`() {
            ...
            testApplication {
                ...
                assertEquals(fastlegeResponse.fastlegekontor.besoeksadresse?.adresse, personBehandlerDTO.adresse)
                assertEquals(fastlegeResponse.fastlegekontor.besoeksadresse?.postnummer, personBehandlerDTO.postnummer)
                assertEquals(fastlegeResponse.fastlegekontor.besoeksadresse?.poststed, personBehandlerDTO.poststed)
