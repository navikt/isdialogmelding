...
fun testEnvironment() = Environment(
    ...
    oppfolgingsplanBackendClientId = testOppfolgingsplanBackendClientId,
    oppfolgingsplanAPIAuthorizedConsumerClientIdList = listOf(testSyfooppfolgingsplanserviceClientId, testOppfolgingsplanBackendClientId),
    electorPath = "/tmp",
...
const val testOppfolgingsplanBackendClientId = "oppfolgingsplan-backend-client-id"
