...
val invalidFellesformatXml = """<?xml version="1.0" ?>
    <IkkeGyldigXML xmlns="http://www.nav.no/xml/eiff/2/" >
    <UgyldigMottakEnhetBlokk partnerReferanse="${UserConstants.PARTNERID}" />
    </EI_fellesformat>"""

val fellesformatXMLHealthcareProfessional = """<?xml version="1.0" ?>
    <EI_fellesformat xmlns="http://www.nav.no/xml/eiff/2/" >
    <MsgHead xmlns="http://www.kith.no/xmlstds/msghead/2006-05-24">
        <HealthcareProfessional>
            ...
            <Ident>
                <Id>${UserConstants.OTHER_HERID}</Id>
                <TypeId V="${BehandleridentType.HER}" S="2.16.578.1.12.4.1.1.8116" DN="Identifikator fra Helsetjenesteenhetsregisteret"/>
            </Ident>
        </HealthcareProfessional>
        </MsgHead>
        <MottakenhetBlokk partnerReferanse="${UserConstants.PARTNERID}" />
...
val fellesformatXMLHealthcareProfessionalInvalidFNR = """<?xml version="1.0" ?>
    <EI_fellesformat xmlns="http://www.nav.no/xml/eiff/2/" >
    <MsgHead xmlns="http://www.kith.no/xmlstds/msghead/2006-05-24">
        <HealthcareProfessional>
            <Ident>
...
fun generateDialogmeldingFromBehandlerDTO(uuid: UUID, orgnr: String? = null) = KafkaDialogmeldingFromBehandlerDTO(
    ...
    legekontorHerId = "" + UserConstants.HERID_KONTOR_OK,
    legekontorOrgName = "",
    legehpr = "",
    fellesformatXML = fellesformatXml,
)

fun generateDialogmeldingFromBehandlerDTOWithInvalidXml(uuid: UUID) = KafkaDialogmeldingFromBehandlerDTO(
    msgId = uuid.toString(),
    navLogId = "1234asd123",
    mottattTidspunkt = LocalDateTime.now(),
    personIdentPasient = "",
    ...
    legekontorOrgName = "",
    legehpr = "",
    fellesformatXML = invalidFellesformatXml,
)

fun generateDialogmeldingFromBehandlerDTO(fellesformatXml: String) = KafkaDialogmeldingFromBehandlerDTO(
