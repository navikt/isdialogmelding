...
fun FastlegeResponse.toBehandler(
    ...
    kontor = BehandlerKontor(
        ...
        adresse = this.fastlegekontor.besoeksadresse?.adresse ?: this.fastlegekontor.postadresse?.adresse,
        postnummer = this.fastlegekontor.besoeksadresse?.postnummer ?: this.fastlegekontor.postadresse?.postnummer,
        poststed = this.fastlegekontor.besoeksadresse?.poststed ?: this.fastlegekontor.postadresse?.poststed,
