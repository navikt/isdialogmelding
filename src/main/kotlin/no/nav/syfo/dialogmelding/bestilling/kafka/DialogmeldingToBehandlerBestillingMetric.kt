...
val COUNT_KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_READ: Counter = Counter.builder(
    KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_READ
)
    .description("Counts the number of reads from topic - DialogmeldingBestilling")
    .register(METRICS_REGISTRY)
val COUNT_KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_DUPLICATE: Counter = Counter.builder(
    KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_DUPLICATE
)
    .description("Counts the number of duplicates received from topic - DialogmeldingBestilling")
    .register(METRICS_REGISTRY)
val COUNT_KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_TOMBSTONE: Counter = Counter.builder(
    KAFKA_CONSUMER_DIALOGMELDING_BESTILLING_TOMBSTONE
)
